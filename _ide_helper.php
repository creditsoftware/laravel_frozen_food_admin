 ...
 * Generated for Laravel 6.12.0 on 2020-12-17 21:05:19.
 *
...
namespace Illuminate\Support\Facades { 
     ...
     * 
     *
     * @method static \Illuminate\Http\RedirectResponse _home(int $status = 302)
     * @see \Illuminate\Routing\Redirector
     */ 
    class Redirect {
        
        /**
         * Create a new redirect response to the "_home" route.
         *
         * @param int $status
